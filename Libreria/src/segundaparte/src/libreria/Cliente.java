...
public class Cliente {
	...
	/*Para que se pueda cambiar en forma dinamica el tipo de cliente y cambiar su comportamiento*/
	...
	public Cliente(String nombre, String apellido, String direccion, long dni) {
		...
		//Por defecto se crea cliente comun
		tipoCliente = new TipoClienteComun();
	...
	*/
	public boolean leGusta(Libro libro){
		return tipoCliente.leGusta(this, libro);
	}
